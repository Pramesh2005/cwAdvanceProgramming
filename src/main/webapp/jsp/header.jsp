    ...
    <div class="container">
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="${pageContext.request.contextPath}//available-scholarships">Available Scholarship</a></li>
               <li><a href="${pageContext.request.contextPath}/scholarship-history">Application History</a></li>
                ...
                <li><a href="${pageContext.request.contextPath}/jsp/userProfile.jsp">Profile</a></li>
